...
/**
 * <p>
 * <b> Nombre </b> Clase Servicios de Proyecto
 * </p>
 * 
 * <p>
 * <strong>Descripcion </strong> Bussines logic de proyectos, recoge formatos
...
public class ProyectosServiceImpl implements ProyectosService {
	...
	public Proyecto selectProyecto(Integer id) {
		...
		RestTemplate restTemplate = new RestTemplate();
		Proyecto proyecto = restTemplate.getForObject("http://localhost:5000/proyectos/admin/select/" + id,
				Proyecto.class);
		log.info("" + proyecto);
		return proyecto;
	}
	...
	public void updateProyectos(Proyecto proyecto) {
		...
		// String
		// url="http://localhost:5000/proyectos/admin/update/"+proyecto.getIdproyecto();
		RestTemplate restTemplate = new RestTemplate();
		restTemplate.put("http://localhost:5000/proyectos/admin/update/" + proyecto.getIdproyecto(), proyecto,
				Proyecto.class);
		// HttpEntity<Proyecto> requestEntity = new HttpEntity<Proyecto>(proyecto);
		// HttpEntity<Proyecto> response = restTemplate.exchange(url, HttpMethod.PUT,
		// requestEntity,Proyecto.class, proyecto);
